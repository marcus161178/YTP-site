...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = '/assets/lighbox/loading.gif';
      this.fileCloseImage = '/assets/lighbox/close.png';
  ...
  Lightbox = (function() {
	...
	Lightbox.prototype.build = function() {
	  ...
	  $(container).append($("<img>", { "class": "nopin lb-image" }));
	  nav = $("<div>", { "class": "lb-nav" });
	  $(nav).append($("<a>", { "class": "lb-pref" }));
