...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { category_id: @subcategory.category_id, name: @subcategory.name, url: @subcategory.url }
    end
  ...
  test "should update subcategory" do
    put :update, id: @subcategory, subcategory: { category_id: @subcategory.category_id, name: @subcategory.name, url: @subcategory.url }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
